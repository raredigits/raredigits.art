...
Combined charts are <code>DualAxes</code> — all chart-level options are identical. See the full list on the <a href="/charts/dual-axes/#options-reference">Dual Axes</a> page.
