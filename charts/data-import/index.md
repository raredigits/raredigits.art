...
Three series, one source array. The right axis (orange line) tracks the BTC spot price. The left axis shows two things at once: the gray bars are daily BTC output scaled by $100,000, and the green line is actual USD earnings. When the line sits above the bars, the BTC price was above $100k and pushed USD revenue higher. When they converge, price is close to the $100k anchor. The tooltip shows actual unscaled BTC values.
