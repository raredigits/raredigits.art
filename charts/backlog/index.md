...
<table class="table-bordered card-caption">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                Allow <code>source</code> to accept <code>{ text, href }</code> in addition to plain string, rendering as an <code>&lt;a&gt;</code> tag for data attribution links.
            </td>
        </tr>
        <tr class="table-section">
            <td colspan="3">
        ...
        <tr>
            ...
            <td>Choropleth and point map for geographic data distribution.</td>
        </tr>
        <tr class="table-section">
            <td colspan="3">
                <h5>Bar series</h5>
        ...
        <tr>
            ...
            <td>Renders formatted value labels above positive bars and below negative bars. Uses `yTickFormat` for formatting. Available on Bar and DualAxes.</td>
        </tr>
        <tr>
